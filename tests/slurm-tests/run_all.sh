...
# sleep 10
python tests/slurm-tests/super_120b_aime25/run_test.py --cluster $CLUSTER --workspace /workspace/nemo-skills-slurm-ci/$RUN_NAME/super_120b_aime25 --expname_prefix super_120b_aime25_$RUN_NAME
# sleep 10
